...
export async function handleMessage(msg) {
  ...
  switch (msg.type) {
    ...
    case 'yeaft_shared_agent_definition':
      await handleYeaftSharedAgentDefinition(msg);
      break;
