...
export const CORE_TEST_FILES = Object.freeze([
  ...
  'test/agent-installer-service.test.js',
  'test/agent-installer-powershell.test.js',
  'test/server/installer-routes.test.js',
  'test/web/agent-installer.test.js',
  ...
  'test/agent/sub-agent/execution-control.test.js',
  ...
  'test/yeaft-message-recall-index.test.js',
  'test/agent/yeaft/config-history-recall.test.js',
  'test/agent/yeaft/engine-recall.test.js',
  ...
  'test/agent/yeaft/shared-agent-bundled-definitions.test.js',
  'test/agent/yeaft/shared-agent-definition.test.js',
  'test/agent/yeaft/shared-agent-store.test.js',
  ...
  'test/server/shared-agent-relay.test.js',
  ...
  'test/web/shared-agents-frontend.test.js',
